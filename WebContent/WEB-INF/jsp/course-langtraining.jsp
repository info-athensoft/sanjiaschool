		...
		<section class="dcare__choose__us__area section-padding--sm bg--white bg-image--1">
			<div class="container">
				...
				<!-- 
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="course-langtraining-title-1"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<p><spring:message code="course-langtraining-content-15"/><br/></p>
					<p><spring:message code="course-langtraining-content-16"/><br/></p>
					<p><spring:message code="course-langtraining-content-17"/><br/></p>
					<p><spring:message code="course-langtraining-content-18"/><br/></p>
					<p><spring:message code="course-langtraining-content-19"/><br/></p>
					<p><spring:message code="course-langtraining-content-20"/><br/></p>
					<p><spring:message code="course-langtraining-content-21"/><br/></p>
					<p><spring:message code="course-langtraining-content-22"/><br/></p>
					<p><spring:message code="course-langtraining-content-23"/><br/></p>
					</div>
					<div class="col-lg-2">
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="gallery">
								<div class="gallery__thumb">
									<a href="#">
										<img src="${site_img_dir}/program/3/1.jpg" alt="gallery images">
									</a>
								</div>
