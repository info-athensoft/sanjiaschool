		...
		<section class="dcare__choose__us__area section-padding--sm bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="localcamps-villamaria-sport3-title"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h5><spring:message code="localcamps-villamaria-sport3-header-1"/></h5>
					<p><spring:message code="localcamps-villamaria-sport3-content-1-1"/></p>
					<p><spring:message code="localcamps-villamaria-sport3-content-1-2"/></p>
					
					<p><br/></p>
					
					
					<h5><spring:message code="localcamps-villamaria-sport3-header-2"/></h5>
					<p><spring:message code="localcamps-villamaria-sport3-content-2-1"/></p>
					<ol>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-1"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-2"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-3"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-4"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-5"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-6"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-2-7"/></li>
					</ol>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-villamaria-sport3-header-3"/></h5>
					<p><spring:message code="localcamps-villamaria-sport3-content-3-1"/></p>
					<ol>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-1"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-2"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-3"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-4"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-5"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-3-6"/></li>
					</ol>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-villamaria-sport3-header-4"/></h5>
					<p><spring:message code="localcamps-villamaria-sport3-content-4-1"/></p>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-villamaria-sport3-header-5"/></h5>
					<p><spring:message code="localcamps-villamaria-sport3-content-5-1"/></p>
					<ol>
						<li><spring:message code="localcamps-villamaria-sport3-item-5-1"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-5-2"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-5-3"/></li>
						<li><spring:message code="localcamps-villamaria-sport3-item-5-4"/></li>
					</ol>
					</div>
					<div class="col-lg-2">
					</div>
