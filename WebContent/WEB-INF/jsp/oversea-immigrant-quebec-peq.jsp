		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="oversea-immigrant-quebec-peq-title"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<p><spring:message code="oversea-immigrant-quebec-peq-content"/></p>
					<p><br/></p>
					<p><br/></p>
					
					<h4><spring:message code="oversea-immigrant-quebec-peq-header-1"/></h4>
					<p><br/></p>
					<ol>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-1-1"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-1-2"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-1-3"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-1-4"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-1-5"/></li>
					</ol>
					<p><br/></p>
					<p><br/></p>
					
					<h4><spring:message code="oversea-immigrant-quebec-peq-header-2"/></h4>
					<p><br/></p>
					<ol>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-1"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-2"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-3"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-4"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-5"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-2-6"/></li>
					</ol>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-2-7"/></p>
					<p><br/></p>
					<p><br/></p>
					
					<h4><spring:message code="oversea-immigrant-quebec-peq-header-3"/></h4>
					<p><br/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-1"/></p>
					
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-2"/></p>
					<ol>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-3-2a"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-3-2b"/></li>
						<li><spring:message code="oversea-immigrant-quebec-peq-content-3-2c"/></li>
					</ol>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-3a"/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-3b"/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-3c"/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-3d"/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-3-3e"/></p>
					<p><br/></p>
					<p><br/></p>
					
					<h4><spring:message code="oversea-immigrant-quebec-peq-header-4"/></h4>
					<p><br/></p>
					<p><spring:message code="oversea-immigrant-quebec-peq-content-4-1"/></p>
