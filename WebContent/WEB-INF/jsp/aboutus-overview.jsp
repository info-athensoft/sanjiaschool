		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				...
				<div class="row mt--20">
					...
					<p><spring:message code="aboutus-section-overview-content-2"/><br/><br/></p>
					
					<p><spring:message code="aboutus-section-overview-content-3"/><br/><br/></p>
					
					<p><spring:message code="aboutus-section-overview-content-4"/><br/><br/></p>
					
					<p><spring:message code="aboutus-section-overview-content-5"/><br/><br/></p>
