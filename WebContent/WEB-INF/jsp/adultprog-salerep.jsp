                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title font-section-title"><spring:message code="page-title-adultprog-salerep"/></h2>
		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="adultprog-salerep-title"/></h2>
							<p><br/><br/></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h4><spring:message code="adultprog-salerep-head-1"/></h4>
					<p><br/></p>
					<p><spring:message code="adultprog-salerep-content-1"/></p>
					...
					<h4><spring:message code="adultprog-salerep-head-2"/></h4>
					<p><br/></p>
					<ul>
						<li><spring:message code="adultprog-salerep-content-2-1"/></li>
						<li><spring:message code="adultprog-salerep-content-2-2"/></li>
						<li><spring:message code="adultprog-salerep-content-2-3"/></li>
						<li><spring:message code="adultprog-salerep-content-2-4"/></li>
						<li><spring:message code="adultprog-salerep-content-2-5"/></li>
					</ul>
