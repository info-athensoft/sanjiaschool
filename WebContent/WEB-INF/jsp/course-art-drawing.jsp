...
<body>
	...
	<div class="wrapper" id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title font-section-title"><spring:message code="class-name-art"/></h2>
                                <nav class="bradcaump-inner">
                                  ...
                                  <a href="/course-art.html?lang=${loc}"><span class="breadcrumb-item"><spring:message code="menu-course-art"/></span></a>
                                  <span class="brd-separetor"><img src="/images/icons/brad.png" alt="separator images"></span>
                                  <span class="breadcrumb-item active"><spring:message code="class-name-art"/></span>
                                </nav>
                            </div>
                        </div>
                    </div>
		...
		<!-- Start Drawing Intro Area -->
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="course-art-drawing-title-1"/></h2>
							<p><spring:message code="course-art-drawing-content-1"/></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<p><spring:message code="course-art-drawing-content-1-1"/><br/></p>
					<p><spring:message code="course-art-drawing-content-1-2"/><br/></p>
					<p><spring:message code="course-art-drawing-content-1-3"/><br/></p>
					<p><spring:message code="course-art-drawing-content-1-4"/><br/></p>
					<p><spring:message code="course-art-drawing-content-1-5"/><br/></p>
		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="course-art-drawing-instructor-1"/></h2>
							<p><spring:message code="course-art-drawing-instructor-1b"/></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<div class="col-lg-8">
						...
						<p><spring:message code="course-art-drawing-instructor-1-1"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-2"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-3"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-4"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-5"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-6"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-7"/><br/></p>
						<p><spring:message code="course-art-drawing-instructor-1-8"/><br/></p>
		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="course-art-drawing-title-2"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					<div class="row galler__wrap">
						<!-- Start Single Gallery -->
						<c:forEach var="picNum" begin="1001" end="1046" step="1">
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="gallery">
								<div class="gallery__thumb">
									<a href="#">
										<img src="${site_img_dir}/course/drawing-work/${picNum}.jpg" alt="gallery images">
									</a>
								</div>
								<div class="gallery__hover__inner">
									<div class="gallery__hover__action">
										<ul class="gallery__zoom">
											<li><a href="${site_img_dir}/course/drawing-work/big/${picNum}.jpg"" data-lightbox="grportimg" data-title="My caption"><i class="fa fa-search"></i></a></li>
											<li><a href="#"><i class="fa fa-link"></i></a></li>
										</ul>
									</div>
								</div>
