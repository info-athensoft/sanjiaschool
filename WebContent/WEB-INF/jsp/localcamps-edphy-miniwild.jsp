		...
		<section class="dcare__choose__us__area section-padding--sm bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="localcamps-edphy-miniwild-title"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h5><spring:message code="localcamps-edphy-miniwild-header-1"/></h5>
					<p><spring:message code="localcamps-edphy-miniwild-content-1-1"/></p>
					<p><br/></p>
					
					<p><spring:message code="localcamps-edphy-miniwild-content-1-2"/></p>
					<p><br/></p>
					
					<p><spring:message code="localcamps-edphy-miniwild-content-1-3"/></p>
					<p><br/></p>
					
					<p><spring:message code="localcamps-edphy-miniwild-content-1-4"/></p>
					<p><br/></p>
					
					<p><spring:message code="localcamps-edphy-miniwild-content-1-5"/></p>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-edphy-miniwild-header-2"/></h5>
					<p><spring:message code="localcamps-edphy-miniwild-content-2-1"/></p>
					<p><br/></p>
