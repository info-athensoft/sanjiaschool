...
<body>
	...
	<div class="wrapper" id="wrapper">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12 md-mt-60 sm-mt-60">
						<div class="service border__color border__color--8 bg__cat--7">
							<div class="service__icon">
								<img src="${webapp_name}/images/shape/sm-icon/4.png" alt="icon images">
							</div>
							<div class="service__details">
		...
		<!-- Start Team Area -->
		<!-- 
		<section class="dcare__team__area pb--150 bg--white section-padding--sm--bottom section-padding--sm--top">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
				...
				<div class="row mt--40">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="team__style--3 team--4 hover-color-2">
							<div class="team__thumb">
								<img src="${webapp_name}/images/team-3/1.jpg" alt="team images">
							</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="team__style--3 team--4 hover-color-2">
							<div class="team__thumb">
								<img src="${webapp_name}/images/team-3/2.jpg" alt="team images">
							</div>
							<div class="team__hover__action">
								<div class="team__details">
									<div class="team__info">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="team__style--3 team--4 hover-color-2">
							<div class="team__thumb">
								<img src="${webapp_name}/images/team-3/3.jpg" alt="team images">
							</div>
							<div class="team__hover__action">
								<div class="team__details">
									<div class="team__info">
