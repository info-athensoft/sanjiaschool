                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title font-section-title"><spring:message code="page-title-adultprog-industrydesign"/></h2>
		...
		<section class="dcare__choose__us__area section-padding--lg bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="adultprog-industrydesign-title"/></h2>
							<p><br/><br/></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h4><spring:message code="adultprog-industrydesign-head-1"/></h4>
					<p><br/></p>
					<p><spring:message code="adultprog-industrydesign-content-1"/></p>
