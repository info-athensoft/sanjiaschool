		...
		<section class="dcare__choose__us__area section-padding--sm bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="localcamps-edphy-language-title"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h5><spring:message code="localcamps-edphy-language-header-1"/></h5>
					<p><spring:message code="localcamps-edphy-language-content-1-1"/></p>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-edphy-language-header-2"/></h5>
					<p><spring:message code="localcamps-edphy-language-content-2-1"/></p>
					<p><br/></p>
					<p><spring:message code="localcamps-edphy-language-content-2-2"/></p>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-edphy-language-header-3"/></h5>
					<p><spring:message code="localcamps-edphy-language-content-3-1"/></p>
					<p><br/></p>
					
					<h5><spring:message code="localcamps-edphy-language-header-4"/></h5>
					<p><spring:message code="localcamps-edphy-language-content-4-1"/></p>
					<ol>
						<li><spring:message code="localcamps-edphy-language-item-4-1"/></li>
						<li><spring:message code="localcamps-edphy-language-item-4-2"/></li>
						<li><spring:message code="localcamps-edphy-language-item-4-3"/></li>
						<li><spring:message code="localcamps-edphy-language-item-4-4"/></li>
					</ol>
