		...
		<section class="dcare__choose__us__area section-padding--sm bg--white bg-image--1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12">
						<div class="section__title text-center">
							<h2 class="title__line font-section-title"><spring:message code="localcamps-villamaria-sport2-title"/></h2>
							<p></p>
						</div>
					</div>
				</div>
				...
				<div class="row mt--20">
					...
					<h5><spring:message code="localcamps-villamaria-sport2-header-1"/></h5>
					<p><spring:message code="localcamps-villamaria-sport2-content-1-1"/></p>
					<ol>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-1"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-2"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-3"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-4"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-5"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-6"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-7"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-8"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-9"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-10"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-11"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-12"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-13"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-14"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-15"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-16"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-17"/></li>
						<li><spring:message code="localcamps-villamaria-sport2-item-1-18"/></li>
					</ol>
					<p><br/></p>
					
					
					<h5><spring:message code="localcamps-villamaria-sport2-header-3"/></h5>
					<p><spring:message code="localcamps-villamaria-sport2-content-3-1"/></p>
					<p><br/></p>
